...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set LCD [ create_bd_port -dir O -type data LCD ]
  set RGB_GREENS [ create_bd_port -dir O -from 1 -to 0 RGB_GREENS ]
  set RGB_REDS [ create_bd_port -dir O -from 1 -to 0 RGB_REDS ]
  ...
  # Create instance: arcade_check_0, and set properties
  set block_name arcade_check
  set block_cell_name arcade_check_0
  if { [catch {set arcade_check_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $arcade_check_0 eq "" } {
  ...
  if { [catch {set led_walk_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $led_walk_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: messenger_0, and set properties
  set block_name messenger
  set block_cell_name messenger_0
  if { [catch {set messenger_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $messenger_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: mul_cheat_detect_0, and set properties
  set block_name mul_cheat_detect
  set block_cell_name mul_cheat_detect_0
  if { [catch {set mul_cheat_detect_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $mul_cheat_detect_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_net -net Reset_1 [get_bd_ports Reset] [get_bd_pins SERIAL_TX_FIFO_0/RST] [get_bd_pins arcade_check_0/rst] [get_bd_pins messenger_0/RST] [get_bd_pins mul_cheat_detect_0/rst]
  connect_bd_net -net SERIAL_CLOCK_0_CLK_TX [get_bd_pins SERIAL_CLOCK_0/CLK_TX] [get_bd_pins SERIAL_TX_FIFO_0/CLK_TX]
  connect_bd_net -net SERIAL_TX_FIFO_0_TX [get_bd_ports LCD] [get_bd_pins SERIAL_TX_FIFO_0/TX]
  connect_bd_net -net arcade_check_0_leds_active [get_bd_pins arcade_check_0/leds_active] [get_bd_pins led_walk_0/active]
  connect_bd_net -net arcade_check_0_result [get_bd_pins arcade_check_0/result] [get_bd_pins messenger_0/result]
  connect_bd_net -net button0_0_1 [get_bd_ports button0] [get_bd_pins mul_cheat_detect_0/button0]
  ...
  connect_bd_net -net messenger_0_RGB_GREENS [get_bd_ports RGB_GREENS] [get_bd_pins messenger_0/RGB_GREENS]
  connect_bd_net -net messenger_0_RGB_REDS [get_bd_ports RGB_REDS] [get_bd_pins messenger_0/RGB_REDS]
